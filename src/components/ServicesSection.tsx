  ...
  return (
    <section id="services" className="py-24 px-6 max-w-7xl mx-auto">
      <div className="text-center">
        <p className="text-xs tracking-[0.2em] text-center mb-4 uppercase" style={{ color: 'hsl(240,4%,66%)' }}>
          OUR SPECIALISATION
        </p>
        <h2 className="text-4xl md:text-5xl text-white text-center font-serif font-normal">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-16">
        <div className="liquid-glass rounded-3xl p-10 border border-white/15">
          ...
          <h3 className="text-2xl text-white mt-8 mb-3 font-serif">Website Design</h3>
          ...
          <div className="flex flex-wrap gap-2 mt-6">
            <span className="rounded-full px-4 py-1.5 text-xs border border-white/15 flex items-center gap-2 text-muted-foreground liquid-glass">
        ...
        <div className="liquid-glass rounded-3xl p-10 border border-white/15">
          ...
          <h3 className="text-2xl text-white mt-8 mb-3 font-serif">E-Commerce Development</h3>
          <p className="text-sm leading-relaxed text-muted-foreground">
