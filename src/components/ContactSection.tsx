  ...
  return (
    <section id="contact" className="py-28 px-6 max-w-4xl mx-auto">
      <div ref={sectionRef} className="reveal">
        <div className="liquid-glass rounded-3xl p-12 md:p-16 text-center border border-white/15">
          ...
          <h2 className="text-4xl md:text-5xl text-white mt-8 font-serif font-normal">Ready to launch your website?</h2>
          <p className="text-lg mt-4 text-white/45">Get a free quote and website proposal within 24 hours. No obligation.</p>
          ...
          <div className="flex gap-4 mt-10 justify-center flex-wrap">
            ...
            <a href="mailto:hello@vadurtech.com.my" className="border border-white/15 rounded-full px-10 py-5 text-sm hover:text-white hover:border-white/25 transition-all cursor-pointer flex items-center gap-2 text-white/50">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-14 pt-14 border-t border-white/8">
            <div className="flex flex-col items-center gap-2 text-sm text-white/40">
              <svg width="20" height="20" viewBox="0 0 20 20" stroke="rgba(255,255,255,0.4)" strokeWidth="1.2" fill="none">
            ...
            <div className="flex flex-col items-center gap-2 text-sm text-white/40">
              ...
              <a href="tel:+601151121248" className="hover:text-white transition-colors">+60 11-5112 1248</a>
            </div>
            <div className="flex flex-col items-center gap-2 text-sm text-white/40">
              <svg width="20" height="20" viewBox="0 0 20 20" stroke="rgba(255,255,255,0.4)" strokeWidth="1.2" fill="none">
                <circle cx="10" cy="10" r="8"/><line x1="10" y1="6" x2="10" y2="10"/><line x1="10" y1="10" x2="14" y2="12"/>
              </svg>
              Mon–Fri, 9am–6pm MYT
            </div>
          </div>
